...
1. 노이즈.빛 없이
----------------------
노이즈, 빛의 효과는 미비한 듯, 보통 데이타에 노이즈, 빛을 이용해 뻥튀기하면 정확도가 떨어짐.
...
2. 데이터 수 줄여보기
----------------------
보통 데이터와 단순화시킨 데이타 모에 대해서는 15,000개 대비 3,000개부터 거의 유사한 결과가 나옴
...
단, 단순화된 데이타에서는 테스트도 남겨두 119개를 단순화시킨 후 테스트하였음.
