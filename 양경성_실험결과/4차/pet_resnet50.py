...
save_model='/home/turbo/study/playground/pet_resnet50/model/resnet50_6.h5'
...
train_dir = '/home/turbo/share/sda1/data/train4'
test_dir  = '/home/turbo/share/sda1/data/valid4'
...
def divide_data(test_portion):
    ...
    source_dir  = '/home/turbo/share/sda1/data/simple_augmented'
...
# ResNet50 모형을 그림으로 볼 수 있습니다.
# SVG(model_to_dot(model, show_shapes=True).create(prog='dot', format='svg'))

# Transfer Learning을 위해 맨 마지막 부분의 Flatten층을 잘라서 불러옵니다.
# 맨 마지막층의 이름이 flatten_1이기 때문에 model.get_layer('flatten_1')를 해서 flatten_1의 텐서를 불러옵니다.
transfer_layer = model.get_layer('flatten_1')
...
for layer in conv_model.layers[174:]:
  layer.trainable=False
...
# early stopping 콜백함수를 만들어서, val_loss를 관찰해보고 만약 5번 이상 계속 val_loss가 떨어질 시 훈련을 종료해줍니다.
